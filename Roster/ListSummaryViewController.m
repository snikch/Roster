...
@implementation ListSummaryViewController

- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([[segue identifier] isEqualToString:@"showModels"]) {
        ListUnitSummaryViewController *vc = (ListUnitSummaryViewController *)[segue destinationViewController];        NSIndexPath *indexPath = [self.tableView indexPathForSelectedRow];
        ListUnit *listUnit = [[self fetchedResultsController] objectAtIndexPath:indexPath];

        [vc setListUnit:listUnit];
    }
}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSArray *sortDescriptors = @[[[NSSortDescriptor alloc] initWithKey:@"unit.classification" ascending:YES], [[NSSortDescriptor alloc] initWithKey:@"unit.name" ascending:YES]];
